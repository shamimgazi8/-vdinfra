...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      className={cn(
        "data-[selected-single=true]:bg-[#04A57D] data-[selected-single=true]:text-white",
        "data-[range-start=true]:bg-[#04A57D] data-[range-start=true]:text-white",
        "data-[range-end=true]:bg-[#04A57D] data-[range-end=true]:text-white",
